  ...
  return (
    <>
      ...
      <main className="work-page source-detail" id="source-content">
        ...
        <section className="project-facts" aria-label="Item facts">
          <dl>
            {facts.map((fact) => (
              <div key={fact.label}>
                <dt>{fact.label}</dt>
        ...
        <section className="case-notes source-notes" aria-label="About this item">
          <article>
        ...
        <section className="project-links" aria-labelledby="source-link-title">
